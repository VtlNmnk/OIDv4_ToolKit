...
MAIN_COLORS = ['red', 'blue', 'black', 'yellow', 'green', 'darkolivegreen', 'darkseagreen', 'darkorange',
               'darkslategrey', 'darkturquoise', 'darkgreen', 'darkviolet', 'darkgray', 'darkmagenta', 'darkblue',
               'darkkhaki', 'darkcyan', 'darkred', 'darksalmon', 'darkslategray', 'darkgoldenrod', 'darkgrey',
               'darkslateblue', 'darkorchid', 'skyblue', 'orange', 'pink', 'violet', 'brown', 'gold', 'Olive',
               'Maroon', 'cyan', 'olivedrab', 'lightcyan', 'silver']
print(type(MAIN_COLORS))
home = os.path.join(os.getcwd(), 'OID', 'Dataset')
...
class LabelTool():
    def __init__(self, master):
        ...
        self.widge.config(bg=COLORS[self.indd], fg='black', activebackground=COLORS[self.indd],
        ...
        self.btnDel = Button(self.frame, text='DeleteSelectedBBox', command=self.delBBox)
        self.btnDel.grid(row=4, column=2, sticky=W + E + N, columnspan=2)
        self.btnClear = Button(self.frame, text='ClearAllBBoxes', command=self.clearBBox)
        self.btnClear.grid(row=5, column=2, sticky=N, columnspan=2)
        self.btnDelImage = Button(self.frame, text='DeleteImage', command=self.delImage)
        self.btnDelImage.grid(row=6, column=2, sticky=N, columnspan=2)
    ...
    def delImage(self):
        ...
        tkMessageBox.showerror("Information!",
                               message="Image {} and it's annotation are deleted".format(self.imagename))
        self.nextImage()
